...
class DiraUserClient extends DiraClient {
    ...
    change_password(data) {
        return this.post({
            url: `${this.original_base_url}/changePassword`,
            data: data
        });
    }

    finalize_reset_password(reset_password_model) {
        return this.post({
            url: `${this.original_base_url}/finalizeResetPassword`,
            data: reset_password_model
        });
    }
}
