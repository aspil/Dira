...
public class EntityModelMapper extends RequestResponseBodyMethodProcessor {
    private static final ModelMapper modelMapper = new ModelMapper();
    private EntityManager entityManager;

    public EntityModelMapper(ObjectMapper objectMapper, EntityManager entityManager) {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(ModelToEntityMapper.class);
    }
    ...
    protected Object readWithMessageConverters(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType) throws IOException, HttpMediaTypeNotSupportedException, HttpMessageNotReadableException {
        for (Annotation ann : parameter.getParameterAnnotations()) {
            ModelToEntityMapper dtoType = AnnotationUtils.getAnnotation(ann, ModelToEntityMapper.class);
            if (dtoType != null) {
